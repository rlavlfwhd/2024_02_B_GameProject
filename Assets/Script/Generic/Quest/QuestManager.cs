...
public class QuestManager : Singleton<QuestManager>
{
    ...
    public bool CanStartQuest(string questId)               //특정 퀘스트를 시작할 수 있는지 검사하는 메서드
    {
        ...
        //FieldInfo perrequisiteIdsField = questType.GetField("prerequisiteQuestIds");
        //object perrequisiteIdsValue = perrequisiteIdsField?.GetValue(quest);
        //List<string> prerequisiteQuestIds = 
        //prerequisiteQuestIds = prerequisiteQuestIds ?? new List<string>();                //null값일 경우에는 빈 List
