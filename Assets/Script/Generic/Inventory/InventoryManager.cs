...
public class InventoryManager : MonoBehaviour  
{
    ...
    void Start()
    {
        ...
        playerInventory.AddItem(new CraftingMaterial("Iron Ingot", 101));
        playerInventory.AddItem(new CraftingMaterial("Iron Ingot", 101));
        playerInventory.AddItem(new CraftingMaterial("Wood", 102));

        playerInventory.AddItem(new CraftingMaterial("Herb", 102));
        playerInventory.AddItem(new CraftingMaterial("Herb", 102));
        playerInventory.AddItem(new CraftingMaterial("Water", 202));
    }
