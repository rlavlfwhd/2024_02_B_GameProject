...
namespace MyGame.CraftingSystem
{
    public class CraftingManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            {
                Debug.LogError("InventroyManager no found !");
            }
        ...
        private void CreateSwordRecipe()
        {
            ...
            recipe.AddRequiredMaterial(101, 2);     //Iron Ingot x2
            recipe.AddRequiredMaterial(102, 1);     //Wood x1
            recipes.Add(recipe.recipeId, recipe);
        }

        private void CreatePotionRecipe()
        {
            var healthPotion = new HealthPotion("Health Potionj", 2001, 50);
